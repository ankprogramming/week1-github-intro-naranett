...
**ชื่อ** นราเนตร **นามสกุล** ยุงกลาง

**เพศ** หญิง

**วันเกิด** 13 มีนาคม 2542
...
1.ตีไข่ไก่แล้วนำไปทอดจนสุก 

2.โขลกพริกขี้หนูกับกระเทียม เกลือป่นนิดหน่อย และน้ำตาลทราย ตำให้พอหยาบ

3.ตั้งกระทะ ใส่น้ำมันลงไป ตามด้วยพริกที่ตำไว้ลงไปผัดให้หอม ตามด้วยไข่คนที่เตรียมไว้ เติมน้ำต้มสุกลงไปเล็กน้อย  ชิมรสตามชอบ สุดท้ายตามด้วยใบกะเพรา ผัดให้เข้ากัน ตักใส่จาน พร้อมเสิร์ฟ
...
2. ไฟล์ประเภท markdown มีนามสกุลไฟล์ คือ **$5 คอมพิวเตอร์ 5$**
3. การเขียน markdown มีข้อดีคือ **$6  เลขที่ 9 6$** 
